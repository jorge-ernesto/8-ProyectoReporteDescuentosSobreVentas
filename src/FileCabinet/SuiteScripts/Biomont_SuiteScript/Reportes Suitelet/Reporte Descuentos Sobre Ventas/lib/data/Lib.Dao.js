...
define(['N'],
    ...
    function (N) {
        ...
        const LABELS = [
            ['custpage_report_title', 'Sales Discount Report', 'Reporte Descuentos Sobre Ventas'],
            ['custpage_report_title_detail', 'Sales Discount Report Detail', 'Detalle del Reporte Descuentos Sobre Ventas'],
